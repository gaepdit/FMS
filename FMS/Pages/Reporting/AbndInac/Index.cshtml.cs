...
namespace FMS.Pages.Reporting.AbndInac
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostCostAsync()
        {
            ...
            IReadOnlyList<AbndCostEstimateReportDto> abndInacReportList = await _repository.GetAbndCostEstimateReportAsync();

            // Export to Excel
            return File(abndInacReportList.ExportExcelAsByteArray(ExportHelper.ReportType.AbndCostEstimateReport), "application/vnd.ms-excel", fileName);
        }
    }
}
