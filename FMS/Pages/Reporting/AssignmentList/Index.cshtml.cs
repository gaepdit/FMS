...
namespace FMS.Pages.Reporting.AssignmentList
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostByCOAsync()
        {
            ...
            IReadOnlyList<AssignmentListReportByCODto> assignmentByCOReportList =
                await _repository.GetAsignmentListByCOAsync();

            return File(assignmentByCOReportList.ExportExcelAsByteArray(ExportHelper.ReportType.Assignment),
        ...
        public async Task<IActionResult> OnPostByCountyAsync()
        {
            ...
            IReadOnlyList<AssignmentListReportByCountyDto> assignmentByCountyReportList =
                await _repository.GetAsignmentListByCountyAsync();

            return File(assignmentByCountyReportList.ExportExcelAsByteArray(ExportHelper.ReportType.Assignment),
                "application/vnd.ms-excel", fileName);
        }
        ...
        public async Task<IActionResult> OnPostByHSIAsync()
        {
            ...
            IReadOnlyList<AssignmentListReportByHSIDto> assignmentByHSIReportList =
                await _repository.GetAsignmentListByHSIAsync();

            return File(assignmentByHSIReportList.ExportExcelAsByteArray(ExportHelper.ReportType.Assignment),
                "application/vnd.ms-excel", fileName);
        }
        ...
        public async Task<IActionResult> OnPostBySiteNameAsync()
        {
            ...
            IReadOnlyList<AssignmentListReportBySiteNameDto> assignmentBySiteNameReportList =
                await _repository.GetAsignmentListBySiteNameAsync();

            return File(assignmentBySiteNameReportList.ExportExcelAsByteArray(ExportHelper.ReportType.Assignment),
                "application/vnd.ms-excel", fileName);
        }
        ...
        public async Task<IActionResult> OnPostByUnitAsync()
        {
            ...
            IReadOnlyList<AssignmentListReportByUnitDto> assignmentByUnitReportList =
                await _repository.GetAsignmentListByUnitAsync();

            return File(assignmentByUnitReportList.ExportExcelAsByteArray(ExportHelper.ReportType.Assignment),
                "application/vnd.ms-excel", fileName);
        }
    }
}
