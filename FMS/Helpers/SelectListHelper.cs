...
namespace FMS.Helpers
{
    public interface ISelectListHelper
    {
        ...
        Task<SelectList> EnvironmentalInterestsSelectListAsync(bool includeInactive = false);
    ...
    public class SelectListHelper : ISelectListHelper
    {
        ...
        public async Task<SelectList> EnvironmentalInterestsSelectListAsync(bool includeInactive = false) =>
            (await _listRepository.GetEnvironmentalInterestsItemListAsync(includeInactive)).ToSelectList();
        ...
        public async Task<SelectList> FilesSelectListAsync(bool includeInactive = false) =>
