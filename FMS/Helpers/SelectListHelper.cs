...
namespace FMS
{
    public interface ISelectListHelper
    {
        ...
        Task<SelectList> AllowedEventTypesSelectListAsync(Guid? id, bool includeInactive = false);
        ...
        Task<SelectList> UserProgramsSelectListAsync(bool includeInactive = false);
        Task<SelectList> UserPositionsSelectListAsync(bool includeInactive = false);
    }
    ...
    public class SelectListHelper : ISelectListHelper
    {
        ...
        public async Task<SelectList> AllowedEventTypesSelectListAsync(Guid? id, bool includeInactive = false) => (await _listRepository.GetAllowedEventTypesListAsync(id, includeInactive)).ToSelectList();
        ...
        public async Task<SelectList> UserProgramsSelectListAsync(bool includeInactive = false) => (await _listRepository.GetUserProgramListAsync(includeInactive)).ToSelectList();
        public async Task<SelectList> UserPositionsSelectListAsync(bool includeInactive = false) => (await _listRepository.GetUserPositionListAsync(includeInactive)).ToSelectList();
    }
