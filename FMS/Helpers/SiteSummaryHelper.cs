...
namespace FMS.Helpers
{
    public class SiteSummaryHelper
    {
        ...
        public async Task<IList<SiteSummaryReportDto>> GetSiteSummaryReports(reportBatchType batchType,
        ...
        public static string GetCleanupStatusLanguage(SiteSummaryReportDto facility)
        {
            ...
            var mrrs5_2 =
                " through institutional and engineering controls to eliminate or reduce present and future threats to human health and the environment.";
            ...
            var mnat =
                "EPD has not yet directed the responsible parties to begin investigation or cleanup under the Hazardous Site Response Act for ";
            ...
            var mper = ".";
            var minac1 =
                "Although directed to by EPD, identified responsible parties are not currently performing the required investigation and/or cleanup under the Hazardous Site Response Act for ";
            var minac2 = ". Enforcement is pending.";
            var mabnd1 =
                "Identified responsible parties are unable or unwilling to conduct the required investigation and/or cleanup under the Hazardous Site Response Act for ";
            var mabnd2 =
                ". EPD may perform these actions using state funding from the Hazardous Waste Trust Fund and may lien the property or pursue cost recovery.";
            ...
            switch (cleanupstat)
            {
                ...
                case "RRS5CIP":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "RRSCIP5":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "RRS5INV":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "RRSINV5":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "RRS5NAT":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "RRSNAT5":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "RRSCIPINV":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "RRSINVCIP":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "RRSCIPNAT":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "RRSNATCIP":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "RRSINVNAT":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "RRSNATINV":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "5RRSCIP":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                // northside
                ...
                case "5CIPRRS":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "5RRSINV":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "5INVRRS":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "5RRSNAT":
                ...
                case "5NATRRS":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "5CIPINV":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "5INVCIP":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "5CIPNAT":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "5NATCIP":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "5INVNAT":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "5NATINV":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "CIPRRS5":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "CIP5RRS":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "CIPRRSINV":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "CIPINVRRS":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "CIPRRSNAT":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "CIPNATRRS":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "CIP5INV":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "CIPINV5":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "CIP5NAT":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "CIPNAT5":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "CIPINVNAT":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "CIPNATINV":
                {
                    clup = mcip + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "INVRRS5":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "INV5RRS":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "INVRRSCIP":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "INVCIPRRS":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "INVRRSNAT":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "INVNATRRS":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "INV5CIP":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "INVCIP5":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "INV5NAT":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "INVNAT5":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "INVCIPNAT":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mnat +
                           mgwater + mper;
                    break;
                }
                case "INVNATCIP":
                {
                    clup = minv + msource + mper + "  " + (landFill ? "" : mnat + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "NATRRS5":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "NAT5RRS":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "NATRRSCIP":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "NATCIPRRS":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "NATRRSINV":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "NATINVRRS":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mrrs +
                           mgwater + mper;
                    break;
                }
                case "NAT5CIP":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "NATCIP5":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "NAT5INV":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "NATINV5":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "NATCIPINV":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : mcip + msoil + mper) + "  " + minv +
                           mgwater + mper;
                    break;
                }
                case "NATINVCIP":
                {
                    clup = mnat + msource + mper + "  " + (landFill ? "" : minv + msoil + mper) + "  " + mcip +
                           mgwater + mper;
                    break;
                }
                case "RRS5ABN":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + mabnd1 +
                           mgwater + mabnd2;
                    break;
                }
                case "RRSABN5":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mabnd1 + msoil + mabnd2) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "5RRSABN":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mabnd1 +
                           mgwater + mabnd2;
                    break;
                }
                case "5ABNRRS":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mabnd1 + msoil + mabnd2) + "  " +
                           mrrs + mgwater + mper;
                    break;
                }
                case "ABN5RRS":
                {
                    clup = mabnd1 + msource + mabnd2 + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " +
                           mrrs + mgwater + mper;
                    break;
                }
                case "ABNRRS5":
                {
                    clup = mabnd1 + msource + mabnd2 + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "RRS5INA":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " + minac1 +
                           mgwater + minac2;
                    break;
                }
                case "RRSINA5":
                {
                    clup = mrrs + msource + mper + "  " + (landFill ? "" : minac1 + msoil + minac2) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                case "5RRSINA":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + minac1 +
                           mgwater + minac2;
                    break;
                }
                case "5INARRS":
                {
                    clup = mrrs5_1 + msource + mrrs5_2 + "  " + (landFill ? "" : minac1 + msoil + minac2) + "  " +
                           mrrs + mgwater + mper;
                    break;
                }
                case "INA5RRS":
                {
                    clup = minac1 + msource + minac2 + "  " + (landFill ? "" : mrrs5_1 + msoil + mrrs5_2) + "  " +
                           mrrs + mgwater + mper;
                    break;
                }
                case "INARRS5":
                {
                    clup = minac1 + msource + minac2 + "  " + (landFill ? "" : mrrs + msoil + mper) + "  " + mrrs5_1 +
                           mgwater + mrrs5_2;
                    break;
                }
                //Abandon sites
        ...
        public static string GetLanguageForGWScore(SiteSummaryReportDto facility, string exLang = "")
        {
            ...
            if (gw_score > 10)
            {
                switch (gw_a)
                {
                    case 45:
                    {
                        gwa = "This site has a known release of " + gw_1d +
                              " in groundwater at levels exceeding the reportable quantity.  ";
                        break;
                    }
                    case 10:
                    {
                        gwa = "This site has a suspected release of " + gw_1d +
                              " in groundwater at levels exceeding the reportable quantity.  ";
                        break;
                    }
                    case 5:
                    {
                        gwa = "This site has a release of " + gw_1d +
                              " that exceeds a reportable quantity because it has the potential to contaminate groundwater. ";
                        break;
                    }
                ...
                switch (gw_1e)
                {
                    ...
                    {
                        gw1e =
                            "This release has resulted in known human exposure greater than or equal to the MCL for " +
                            gw_1d + ".  ";
                        break;
                    }
                    case 20:
                    ...
                    {
                        gw1e =
                            "This release has resulted in known human exposure, with no MCL having been established for " +
                            gw_1d + ".  ";
                        break;
                    }
                    case 15:
        ...
        public static string GetLanguageForOSScore(SiteSummaryReportDto facility)
        {
            ...
            else
            {
                switch (os_b)
                {
                    case 25:
                    {
                        osb = "This site has a known release of " + os_1d +
                              " in soil at levels exceeding the reportable quantity.  ";
                        break;
                    }
                    case 15:
                    {
                        osb = "This site has a suspected release of " + os_1d +
                              " in soil at levels exceeding the reportable quantity.  ";
                        break;
                    }
                ...
                osLang = osb + osa + "The nearest resident individual is " + os1em +
                         " from the area affected by the release.  ";
            }
