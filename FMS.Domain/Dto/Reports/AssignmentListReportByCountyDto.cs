...
{
    public class AssignmentListReportByCountyDto
    {
        public AssignmentListReportByCountyDto() { }

        public AssignmentListReportByCountyDto(Facility facility)
        {
            ...
            CountyName2 = facility.County?.Name;
        ...
        public string CountyName2 { get; set; }
