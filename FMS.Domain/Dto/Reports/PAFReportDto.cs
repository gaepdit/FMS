...
namespace FMS.Domain.Dto
{
    public class PAFReportDto
    {
        ...
        public DateOnly? PAFIssueDate { get; set; }
        ...
        public DateOnly? ProjectCompleteDue { get; set; }

        [Display(Name = "Project Complete Actual")]
        [XLColumn(Header = "Project Complete Actual")]
        public DateOnly? ProjectCompleteActual { get; set; }
